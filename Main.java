...
public class Main {
    ...
    static final String AttendanceFile = "Attendance Record.csv"; // Path to Attendance Record.csv file
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    AttendanceRecords.attendance(AttendanceFile); // View Attendance Records and calculated hours worked
                    break;
                case "5":
